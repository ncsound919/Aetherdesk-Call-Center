...
ui_env_cmd = 'set ENCRYPTION_KEY=SkYXQ9OlgNAkCoikdZW9NQLYhRbdgQSrV7vfrnCjxLA= && set WEBSOCKET_SECRET_KEY=test-websocket-secret && npm run dev -- --host 127.0.0.1 --port 3001'
subprocess.Popen(
    ['cmd', '/c', ui_env_cmd],
    cwd=ui_base,
    creationflags=subprocess.CREATE_NEW_CONSOLE
