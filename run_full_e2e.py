#!/usr/bin/env python3
"""
Run full E2E system tests in headed mode (visible browser)
Tests the complete system workflow from login to call handling
"""
import os
import sys
import subprocess
...
ui_env["ENCRYPTION_KEY"] = "REDACTED_ENCRYPTION_KEY_PLEASE_ROTATE="
...
print("\n" + "=" * 60)
print("Running FULL E2E system tests in headed mode...")
print("=" * 60)

# Run ALL E2E tests (not just UI) in headed mode
