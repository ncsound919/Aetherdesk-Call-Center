...
if not defined ENCRYPTION_KEY set "ENCRYPTION_KEY=SkYXQ9OlgNAkCoikdZW9NQLYhRbdgQSrV7vfrnCjxLA="
...
start "AetherDesk UI" cmd /c "title [UI] AetherDesk UI & color 0B & cd /d C:\Users\User\Desktop\aetherdesk_scaffold\agent-ui & set VITE_API_URL=http://127.0.0.1:8000 & set ENCRYPTION_KEY=SkYXQ9OlgNAkCoikdZW9NQLYhRbdgQSrV7vfrnCjxLA= & npx vite dev --host 127.0.0.1 --port 3001 --strictPort & pause"
