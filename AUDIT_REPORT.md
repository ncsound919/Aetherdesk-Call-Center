...
```yaml
DEEPGRAM_API_KEY: "REDACTED_DEEPGRAM_KEY"
...
### 2. Stale Domain References — **RESOLVED**
**Files:** `kubernetes/deployment.yml`, `kubernetes/ssl.yml`, `kubernetes/services.yml`, `scripts/deploy_gke.bat`, `config/fonster/config.json`  
All stale domain references have been replaced with `aetherdesk.com` across the codebase.
