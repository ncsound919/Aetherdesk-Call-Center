...
start "UI Server" cmd /c "title UI Server ^& color 0B ^& set ENCRYPTION_KEY=SkYXQ9OlgNAkCoikdZW9NQLYhRbdgQSrV7vfrnCjxLA= && set WEBSOCKET_SECRET_KEY=test-websocket-secret && npx vite --host 127.0.0.1 --port 3001"
