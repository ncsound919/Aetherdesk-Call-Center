...
class ConversationQualityService:
    def _score_criterion(
        self, transcript: str, keywords: list[str], max_score: int
    ) -> int:
    ...
    def score_conversation(
        self, transcript: str, rubric_name: str = "standard"
    ) -> dict:
        logger.info(
        ...
        criteria_scores = {
            ...
            "professionalism": self._score_criterion(
                transcript, PROFESSIONALISM_KEYWORDS, 10
            ),
        }
    ...
    async def get_quality_scores(
        self, tenant_id: str, agent_id: str | None = None, period: str = "30d"
    ) -> list[dict]:
