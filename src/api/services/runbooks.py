...
RUNBOOKS = {
        ...
        "steps": [
            {
                ...
                "description": "Check Twilio/Fonoster status page",
                "timeout_seconds": 60,
            },
            {
                "order": 2,
                "action": "test_sip_connectivity",
                "description": "Test SIP trunk reachability",
                "timeout_seconds": 30,
            },
            {
                "order": 3,
                "action": "check_freeswitch_status",
                "description": "Check FreeSWITCH process status",
                "timeout_seconds": 15,
            },
            {
                "order": 4,
                "action": "enable_failover",
                "description": "Enable secondary telephony provider",
                "timeout_seconds": 30,
            },
            {
                "order": 5,
                "action": "notify_escalation",
                "description": "Notify on-call engineer and escalation contacts",
                "timeout_seconds": 60,
            },
        ],
        "escalation_paths": [
            ...
            {
                "level": 2,
                "contacts": ["engineering-lead", "ops-manager"],
                "timeout_minutes": 30,
            },
    ...
    "database_failure": {
        ...
        "steps": [
            {
                "order": 1,
                "action": "check_db_process",
                "description": "Verify database process is running",
                "timeout_seconds": 30,
            },
            {
                "order": 2,
                "action": "check_connections",
                "description": "Check connection pool and active connections",
                "timeout_seconds": 30,
            },
            {
                "order": 3,
                "action": "check_disk_space",
                "description": "Verify disk space for WAL and data",
                "timeout_seconds": 15,
            },
            {
                "order": 4,
            ...
            {
                "order": 5,
                "action": "activate_readonly_mode",
                "description": "Enable read-only mode if write fails",
                "timeout_seconds": 30,
            },
        ],
        "escalation_paths": [
            ...
            {
                "level": 2,
                "contacts": ["dba-lead", "engineering-lead"],
                "timeout_minutes": 20,
            },
        ],
    },
    "llm_degradation": {
        ...
        "steps": [
            {
                "order": 1,
                "action": "check_llm_health",
                "description": "Check Groq/Ollama endpoint health",
                "timeout_seconds": 30,
            },
            {
                "order": 2,
                "action": "check_rate_limits",
                "description": "Verify API rate limits not exceeded",
                "timeout_seconds": 15,
            },
            {
                "order": 3,
            ...
            {
                "order": 4,
                "action": "enable_cached_responses",
                "description": "Enable cached response mode for common intents",
                "timeout_seconds": 60,
            },
        ],
        "escalation_paths": [
    ...
    "security_incident": {
        ...
        "steps": [
            ...
            },
            {
                ...
                "description": "Preserve logs and audit trails",
                "timeout_seconds": 30,
            },
            {
                "order": 3,
                "action": "assess_scope",
                "description": "Assess scope and impact of the incident",
                "timeout_seconds": 300,
            },
            {
                "order": 4,
                "action": "notify_legal",
                "description": "Notify legal and compliance teams if data breach",
                "timeout_seconds": 600,
            },
            {
                "order": 5,
                "action": "notify_customers",
                "description": "Notify affected customers per regulatory requirements",
        ...
        "steps": [
            {
                "order": 1,
                "action": "check_provider_status",
                "description": "Check provider status page and API health",
                "timeout_seconds": 30,
            },
            {
                "order": 2,
                "action": "switch_to_fallback",
                "description": "Switch to fallback provider (e.g., Deepgram→alternate STT)",
                "timeout_seconds": 60,
            },
            {
                "order": 3,
                "action": "notify_provider_support",
                "description": "Open support ticket with provider",
                "timeout_seconds": 300,
            },
            {
                "order": 4,
...
class RunbookEngine:
    def trigger_runbook(self, incident_type: str, context: dict = None) -> dict:
        ...
        incident = {
            ...
            "log": [
                {
                    "timestamp": time.time(),
                    "event": "runbook_triggered",
                    "details": f"Runbook '{runbook['name']}' triggered",
                }
            ],
        }
    ...
    def get_active_incidents(self, tenant_id: str = None) -> list:
        ...
        if tenant_id:
            incidents = [
                i for i in incidents if i["context"].get("tenant_id") == tenant_id
            ]
    ...
    def advance_step(self, incident_id: str, result: str = None) -> dict:
        ...
        if incident["current_step"] > len(incident["steps"]):
            ...
            incident["log"].append(
                {"timestamp": time.time(), "event": "runbook_resolved"}
            )
