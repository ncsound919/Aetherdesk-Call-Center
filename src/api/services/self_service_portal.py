...
class SelfServicePortalService:
        ...
        return {
            ...
            "csat_scores": [
                ...
                },
                {
                    "call_id": "CL-002",
                    "rating": 4,
                    "feedback": "Helpful but took a bit long",
                    "date": "2025-06-19",
                },
            ],
            "average_csat": 4.5,
    ...
    async def schedule_call_back(
        self, customer_id: str, preferred_time: str, reason: str
    ) -> dict:
        callback = {
            "id": str(uuid.uuid4()),
            "customer_id": customer_id,
    ...
    async def update_preferences(self, customer_id: str, preferences: dict) -> dict:
        ...
        logger.info(
            "Preferences updated", customer_id=customer_id, preferences=filtered
        )
        return {
            "customer_id": customer_id,
