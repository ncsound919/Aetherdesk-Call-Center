...
echo ========================================
echo.
echo  API:  https://api.overlay365.com
echo  App:  https://app.overlay365.com
echo.
...
echo.
echo  DNS Setup:
echo    api.overlay365.com A -^> LoadBalancer IP
echo    app.overlay365.com A -^> LoadBalancer IP
echo.
