...
class SecurityFixValidator:
    ...
    async def test_api_keys_rotated(self):
        ...
        has_deepgram_key = os.getenv("DEEPGRAM_API_KEY", "REPLACE_WITH_DEEPGRAM_API_KEY") in content
        has_groq_key = os.getenv("GROQ_API_KEY", "REPLACE_WITH_GROQ_API_KEY") in content
