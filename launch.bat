...
start "AetherDesk UI Server" cmd /c "title UI Server ^& color 0B ^& cd /d C:\Users\User\Desktop\aetherdesk_scaffold\agent-ui ^& set VITE_API_URL=http://127.0.0.1:8000 ^& set ENCRYPTION_KEY=REDACTED_ENCRYPTION_KEY_PLEASE_ROTATE= ^& npx vite dev --host 127.0.0.1 --port 3001 --strictPort ^& pause"
